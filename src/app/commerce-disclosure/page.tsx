  ...
  return (
    <SharedLayout>
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        <Section title="Price">
          Prices are displayed on each product page. Taxes are included/excluded
          as indicated.
        </Section>
        ...
        <Section title="Exchanges & Returns Policy">
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mb-3">
                We understand that travel plans can change. To receive a refund,
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong>24 to 72 Hours Before Tour Start:</strong> 50% refund
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong>Advance Requests:</strong> Rescheduling requests made
                  more than 48 hours in advance will be accommodated free of
                  charge, subject to vehicle and guide availability.
                </li>
                <li>
                  <strong>Last-Minute Requests:</strong> Requests made within 24
                  hours of the tour start time will be treated as a new booking.
                  The original booking will follow the cancellation policy
                  above.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Tours operate <strong>&quot;Rain or Shine&quot;</strong>. The
                  car community is active in all weather conditions.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong>No-Show:</strong> If the group is not present after 15
                  minutes, the tour will be marked as a &quot;No-Show&quot; and
