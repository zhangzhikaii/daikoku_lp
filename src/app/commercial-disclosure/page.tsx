        ...
        <main className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 leading-relaxed">
            ...
            <Section title="Additional Fees">
              No additional fees will be incured, as everything (tolls, gas,
              car) are all included in the booking price
            </Section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      ...
                      made more than 48 hours in advance will be accommodated
                      free of charge, subject to vehicle and guide availability.
                    </li>
                    <li>
                      <strong>Last-Minute Requests:</strong> Requests made
                      within 24 hours of the tour start time will be treated as
                      a new booking. The original booking will follow the
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>
                      ...
                      Japanese Highway Police may temporarily close access to
                      the Daikoku Parking Area (PA) due to overcrowding or noise
                      control.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      issued due to police-mandated closures, as the tour,
                      vehicle access, and expert commentary are still provided.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>
                      <strong>No-Show:</strong> If the group is not present
                      after 15 minutes, the tour will be marked as a
